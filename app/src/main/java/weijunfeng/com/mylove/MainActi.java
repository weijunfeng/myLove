...
public class MainActi extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
...
//                this.getResources().getColor(R.color.color4));
        ...
        networkListener = new AbsNextWorkListener<WeiXin>() {
            ...
            public void onHandleSuccess(WeiXin weiXin) {
                recyclerView.setAdapter(new SimpleAdapter(MainActi.this, weiXin.getItems()));
